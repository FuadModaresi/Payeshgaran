...
const ProjectsPage = () => {
  const projects = [
    ...
    {
      id: 5,
      title: 'رویداد بزرگ درختکاری در منطقه شمال غرب',
      description: 'مشارکت در بزرگترین رویداد درختکاری کشور با کاشت ۲۲۰ هزار اصله درخت مثمر. این پروژه با شعار "نهال ایثار، بیاد هر شهید یک درخت" انجام شد و هدف آن علاوه بر توسعه فضای سبز، گرامیداشت یاد شهدا بوده است.',
      image: '/images/tree_planting_project.jpeg',
      date: '۱۴۰۱/۱۲/۱۴',
      location: 'منطقه شمال غرب کشور',
      results: 'کاشت و نگهداری از درختان مثمر، ایجاد اشتغال برای جوانان محلی، و افزایش آگاهی عمومی درباره اهمیت درختکاری',
      source: 'پایگاه خبری سازمان منطقه آزاد ماکو - آغاز بزرگترین رویداد درختکاری کشور'
    }
  ];
